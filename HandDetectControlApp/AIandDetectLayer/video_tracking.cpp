...
video_tracking::video_tracking(QObject *parent) : QObject(parent)
{
...
int video_tracking:: video_tracking_hand(int argc, char** argv)
{
    try
    {
        if (argc != 2)
...
void video_tracking::CaptureImage()
{

}

void video_tracking::getImagePath(QString imagePath)
{
