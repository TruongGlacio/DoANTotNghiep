...
class BrainScanDataset(utils.Dataset):
    ...
    def load_brain_scan(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            self.add_image( "tumor", image_id=a['filename'],  # use file name as a unique image id
...
class BrainTumorMask_RCNN:
    ...
    def predict_and_plot_differences(self,dataset, img_id):
        ...
        visualize.display_differences( original_image,  gt_box, gt_class_id, gt_mask, r['rois'], r['class_ids'], r['scores'], r['masks'],
                                       class_names = ['tumor'], title="", ax=get_ax(), show_mask=True, show_box=True)
    
    def Function4_ValidationSet(self):
        ind = 0
    ...
    def BrainTumorMask_RCNN(self):
        self.Function1()
        self.Function2_SetConfig()
        self.Function3()
        self.Function4_ValidationSet()
        self.Function5_Test_Set()
